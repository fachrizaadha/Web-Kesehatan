        ...
        <div class="row">
            <div class="col-md-3">
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                        <div class="row">
                            <?php $alert = isset($_POST['alert']) ? $_POST['alert'] : 'reguler_table'; ?>
                            <div class="col-md-6">
                                <div class="radio" style="margin-bottom: 0px; margin-top: 0px">
                                    <label>
                                        <input type="radio" name="alert" value="biasa" <?php echo $alert == 'biasa' ? 'checked' : ''; ?>>
                                        Biasa
                                    </label>
                                </div>                            
                            </div>
                            <div class="col-md-6">
                                <div class="radio" style="margin-bottom: 0px; margin-top: 0px">
                                    <label>
                                        <input type="radio" name="alert" value="sweet" <?php echo $alert == 'sweet' ? 'checked' : ''; ?>>
                                        Sweet Alert
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <label>Custom KODE SM-20170517 002 (11,3)</label>
                        
                        <input type="text" id="kdauto" name="kdauto" value="<?php echo isset($_POST['kdauto']) ? $_POST['kdauto'] : '' ?>" class="form-control" placeholder="ext. SM-" />
                    </div>
                    
                     <div class="form-group">
                        <label>Batas depan</label>
                        <input type="text" id="a1" name="a1" value="<?php echo isset($_POST['a1']) ? $_POST['a1'] : '' ?>" class="form-control" placeholder="ext. 11" />
                    </div>
                    
                               <div class="form-group">
                        <label>Batas Belakang</label>
                        <input type="text" id="a2" name="a2" value="<?php echo isset($_POST['a2']) ? $_POST['a2'] : '' ?>" class="form-control" placeholder="ext. 3" />
                    </div>
